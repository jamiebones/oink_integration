...
function App() {
  ...
  async function loadDetails() {
    ...
    console.log(totalReferral.toString());
  }
  ...
  const claimOinkTokensMinted = async () => {
    const oinkContract = new ethers.Contract(
      contractAddress,
      ABI,
      web3Provider
    );
  ...
  const approveBSCTokenWithdrawal = async () => {
    ...
    await bscContract
      .connect(signer)
      .approve(contractAddress, ethers.utils.parseEther(ointTokenBalance));
    alert(
      `Approval granted to OINK token to spend funds on behalf of ${address}`
    );
  };
  ...
  const stakeBSCToken = async () => {
    try {
      ...
      await oinkContract
        .connect(signer)
        .stakeBUSD(refferal, ethers.utils.parseEther(bscStakeText));
  ...
  const stakeOinkToken = async () => {
    ...
    try {
      await oinkContract
        .connect(signer)
        .stakeToken(ethers.utils.parseEther(tokenToStake));
  ...
  const sellOinkToken = async () => {
    ...
    try {
      await oinkContract
        .connect(signer)
        .sellToken(ethers.utils.parseEther(oinkToSell));
          ...
          <div className="container-fluid">
            <a className="navbar-brand" href="#">
              <img
                ...
                width="50"
                height="34"
                className="im d-inline-block align-text-top"
              />
              $OINK NETWORK
            </a>
              ...
              <div className="row">
                <div className="col">
                  <div className="display-divHeading">
                    <p className="heading-para">OINK NETWORK STATISTICS</p>
                  ...
                  <div className="d-flex align-items-center flex-column div-price">
                    ...
                    <p className="oink-price">{tokenPrice}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="col">
                  <div className="div-content d-flex justify-content-center">
                    <div className="div-border">
                      <p>Total supply</p>
                      <p className="value">{circulatingSupply}</p>
                    </div>
                    <div className="div-border">
                    ...
                    <div className="div-border">
                      ...
                      <p className="value">{availableSupply}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-4">
                <div className="div-card">
                  <div className="div-one">
                    ...
                    <p>
                      Mint $OINK by staking your $BUSD You can stake as many
                      times as you want You cannot unstake your $BUSD
                    </p>
                  </div>
                  <div className="div-two">
                    <p>
                      APR <span>{apyMinted}%</span>
                    </p>
                    <p>
                      My Stake <span>{userBscStaked} BUSD</span>
                    </p>
                    <p>
                      Total Staked <span>{contractBUSDBalance} $BUSD</span>
                    </p>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="input-group mb-3">
                        <input
                          ...
                          onChange={(e) => setBscApprovedAmount(e.target.value)}
                        />
                        <button
                          className="btn btn-primary"
                          type="button"
                          id="approve"
                          onClick={approveBSCTokenWithdrawal}
                        >
                          Approve
                        </button>
                      </div>
                      ...
                      <div className="input-group mb-3">
                        <div className="input-group">
                          <input
                            ...
                            value={bscStakeText}
                            className="form-control"
                            onChange={(e) => setBscStateText(e.target.value)}
                          />

                          <button
                            className="btn btn-primary"
                            type="button"
                            onClick={() => setBscStateText(bscBalance)}
                          >
                            Max
                          </button>
                  ...
                  <p className="text-center">
                    Wallet Balance: {bscBalance} $BUSD{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-4">
                <div className="div-card">
                  <div className="div-one">
                    ...
                    <p>
                      Stake $OINK to earn more $OINK You can stake as many times
                      as you want You can unstake your $OINK after 7 days
                    </p>
                  </div>

                  <div className="div-two">
                    <p>
                      APR <span>{apyStaked}%</span>
                    </p>
                    <p>
                      My Stake <span>{myOinkStake} OINK</span>
                    </p>
                    <p>
                      Total Staked <span>{totalStakedToken} OINK</span>
                    </p>
                  </div>
                  <div className="div-three">
                    ...
                    <div>
                      ...
                      <div className="input-group">
                        ...
                        <button
                          className="btn btn-primary"
                          type="button"
                          onClick={() => setTokenToStake(bscBalance)}
                          type="button"
                        >
                          MAX
                        </button>
                  ...
                  <p className="text-center">
                    Wallet Balance: {userTokenBalance} $OINK{" "}
                  </p>
                </div>
              </div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-4">
                <div className="div-card">
                  <div className="div-one">
                    ...
                    <p>
                      Sell the earned tokens Only 40000 tokens can be sold per
                      day Earn $BUSD
                    </p>
                  </div>
                  ...
                  <div className="div-two">
                    <p>
                      Sold Today <span>{totalSoldToday}</span>
                    </p>
                    <p>
                      Available Today <span>{totalAvailableToSell}</span>
                    </p>
                    <p>
                      Reset in{" "}
                      <span className="time">
                        {dateConverter(getTimeToNextDay)}
                      </span>
                    </p>
                  </div>
                  <div className="div-three">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        value={oinkToSell}
                        className="form-control"
                        onChange={(e) => setOinkToSell(e.target.value)}
                      />

                      <button
                        className="btn btn-success"
                        onClick={sellOinkToken}
                        type="button"
                      >
                        SELL
                      </button>
